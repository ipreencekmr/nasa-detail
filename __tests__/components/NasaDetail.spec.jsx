...
import {
  NasaDetail, mapDispatchToProps, mapStateToProps, loadModuleData,
} from '../../src/components/NasaDetail';
...
describe('NasaDetail should render as expected', () => {
  it('module should render correct JSX', () => {
    ...
    const renderedModule = shallow(<NasaDetail {...props} />);
  ...
  describe('mapDispatchToProps', () => {
    it('should update the browser locale and then reload the language pack', async () => {
      ...
      expect(mockDispatch).toHaveBeenNthCalledWith(2, 'I am loading the language pack for nasa-detail and my fallback locale is en-US');
    });
  });
